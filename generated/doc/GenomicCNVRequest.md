...
<div id="schema-header-title">
  <h2>GenomicCNVRequest <span id="schema-header-title-project">[beacon-v2] <a href="https://github.com/ga4gh-beacon/specification-v2-test-schemas" target="_BLANK">&nearr;</a></span> </h2>
</div>
...
<li><a href="https://orcid.org/0000-0002-9903-4248">Michael Baudis</a></li>
  ...
  <tr>
    ...
    <td>
      <ul>
        <li><a href="current/GenomicCNVRequest.json" target="_BLANK">raw source [JSON]</a></li>
        <li><a href="https://github.com/ga4gh-beacon/specification-v2-test-schemas/blob/master/schemas/GenomicCNVRequest.yaml" target="_BLANK">Github</a></li>
      </ul>
    </td>
  </tr>
</table>
...
__Type:__ object  
__Description:__ Search for a genomic CNV. Fields to be defined.
