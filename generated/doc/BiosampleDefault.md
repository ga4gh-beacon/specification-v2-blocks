...
<div id="schema-header-title">
  <h2>BiosampleDefault <span id="schema-header-title-project">[beacon-v2] <a href="https://github.com/ga4gh-beacon/specification-v2-test-schemas" target="_BLANK">&nearr;</a></span> </h2>
</div>
...
<li>Michael Baudis (ORCID:0000-0002-9903-4248)</li>
  ...
  <tr>
    ...
    <td>
      <ul>
        <li><a href="current/BiosampleDefault.json" target="_BLANK">raw source [JSON]</a></li>
        <li><a href="https://github.com/ga4gh-beacon/specification-v2-test-schemas/blob/master/schemas/BiosampleDefault.yaml" target="_BLANK">Github</a></li>
      </ul>
    </td>
  </tr>
</table>
